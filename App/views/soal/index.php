        ...
        <div class="card-body">
            ...
            <div class="form-answer">
                <div class="form-group">
                    ...
                    <?php if(!is_null($d['d'])): ?>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="customRadio<?=$no?>4" name="kencana_jawaban<?=$no?>" value="c">
                        <label for="customRadio<?=$no?>4" class="custom-control-label text-md"></label>
