    ...
    <div class="card-body login-card-body">
      ...
      <form action="<?=BASEURL?>auth/validation" method="post">
        <div class="input-group mb-3">
          <input type="text" name="kencana_username" class="form-control" placeholder="Username">
        ...
        <div class="input-group mb-3">
          <input type="password" name="kencana_password" class="form-control" placeholder="Password">
          <div class="input-group-append">
            <div class="input-group-text">
