                        ...
                        <div class="col-md-6" id="viewQuestRoleGuru">
                            <div class="form-group d-none" id="roleMatapelajaran">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="kencana_admin_mapelguru" class="custom-control-input" id="customRadio<?=$d['id']?>" name="customRadio">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="custom-control custom-checkbox mr-4">
                                            <input type="checkbox" name="kencana_admin_kelasguru[]" class="custom-control-input" id="kelasCheckbox<?=$d['id']?>" value="<?=$d['id']?>" checked>
                            ...
                            <div class="d-none" id="roleWalikelas">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="kencana_admin_mapelguru[]" class="custom-control-input" id="mapelCheckbox<?=$d['id']?>" value="<?=$d['id']?>" checked>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <?php foreach ($data['kelas'] as $d) : ?>
                                            <div class="custom-control custom-checkbox mr-4">
                                                <input type="checkbox" name="kencana_admin_kelasguru[]" class="custom-control-input" id="kelasCheckbox<?=$d['id']?>" value="<?=$d['id']?>">
                                                <label for="kelasCheckbox<?=$d['id']?>" class="custom-control-label"><?=$d['kelas']?></label>
                                            </div>
                                            <?php endforeach; ?>
                                        </div>
